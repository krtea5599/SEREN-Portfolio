...
export const PILLARS: Project[] = [
  {
    ...
    achievements: [
      "AI 기반 전자책 출판사 운영 및 ISBN 발급 시스템 구축",
      "교보문고 eBook 유통 및 자체 쇼핑몰/스마트스토어 운영",
      "대표 저작물: 《AI를 이용한 특허출원하기》 시리즈 (1~3권)",
  ...
  },
  {
    ...
    category: "PLATFORM",
    title: "위치기반 교육/방탈출",
    description: "온라인을 넘어 오프라인 공간을 게임화(Gamification)합니다.",
    fullDescription: "관광지, 리조트, 학교 등 물리적 공간을 미션 기반의 게임 공간으로 변모시키는 인터랙티브 플랫폼입니다.",
    features: [
      "위치기반 미션형 방탈출 시스템 'Family Time'",
      "오프라인 미션 키트 및 실물 교구재 연계",
      "지자체 및 리조트 맞춤형 관광 콘텐츠 기획",
      "사용자 경험(UX) 중심의 게이미피케이션 설계"
    ],
    image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=2070&auto=format&fit=crop",
    tags: ["Gamification", "Platform", "Edutech"]
  },
  {
    id: 6,
    category: "LIFESTYLE",
    title: "세렌 토탈 홈케어 & 브랜드화",
...
export const SYSTEMS: ServiceSystem[] = [
  {
    ...
    items: ["Stibee Email Automation", "n8n / Zapier Workflow", "Lead Generation Systems"]
  },
  {
    title: "CONTENT CHANNELS",
    items: ["Instagram Insights", "YouTube Strategy", "AI Monetization Content"]
  },
  {
    title: "THOUGHT LEADERSHIP",
    items: ["Global Intelligence Analysis", "Creative Frameworks", "AI Ethics & Sovereignty"]
  }
];
