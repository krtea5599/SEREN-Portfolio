      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
        <div className="max-w-xs">
          <p className="text-[10px] font-black uppercase leading-tight tracking-tighter opacity-60">
            Brand Development, AI Integration, Content Strategy, Intellectual Property, 1-Person Empire Design.
          </p>
        </div>
        
        <div className="flex flex-col md:items-end space-y-2">
          <a href="mailto:info@serengroup.com" className="text-xs font-bold uppercase border-b border-black pb-1 hover:opacity-50 transition-opacity">info@serengroup.com</a>
